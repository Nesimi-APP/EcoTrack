...
function EntryRow({
  ...
  return (
    ...
    >
      <View
        style={[styles.entryIcon, { backgroundColor: colors.secondary }]}
      >
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          N {item.transport.toFixed(1)} · E {item.energy.toFixed(1)} · Q{" "}
          {item.food.toFixed(1)} kq
        </Text>
      </View>
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        >
          <View
            style={[styles.tipBadge, { backgroundColor: colors.secondary }]}
          >
            <MaterialCommunityIcons
        ...
        >
          ...
          <View style={styles.barChart}>
            {weeklyData.map((d, i) => {
              const barH =
                maxWeekly > 0 ? (d.value / maxWeekly) * 60 : 4;
              return (
        ...
        {recentEntries.length === 0 ? (
          ...
          recentEntries.map((entry) => (
            <EntryRow key={entry.id} item={entry} />
          ))
        )}
      </ScrollView>
    </View>
